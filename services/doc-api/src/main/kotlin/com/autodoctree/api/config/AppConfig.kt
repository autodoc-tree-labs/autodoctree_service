...
data class TreeProperties(
    ...
    val neighborMinSimilarityAuto: Boolean = false,
    val neighborMinSimilarityAutoMargin: Double = 0.05,
    val neighborMutualKnn: Boolean = true,
    val neighborSharedNeighborJaccardMin: Double = 0.10,
    val neighborEdgeBudget: Int = 6,
    val neighborDegreeCap: Int = 10,
    val neighborBridgePrunePolicy: String = "LOWEST_SIM_FIRST",
    val assignAutoThreshold: Double = 0.80,
    val assignRecommendThreshold: Double = 0.60,
    val assignQuarantineEnabled: Boolean = true,
    val templateIsolationEnabled: Boolean = false,
    val templateScoreThreshold: Double = 0.64,
    val templateBoilerplateRatioThreshold: Double = 0.50,
    val templateNgramRepeatThreshold: Double = 0.18,
    val templateFingerprintMinDocs: Int = 3,
    ...
    val clusterMergeMinAffinity: Double = 0.55,
    val clusterSplitRetryWithHigherResolution: Boolean = true,
    val clusterSplitRetryResolutionMultiplier: Double = 1.5,
