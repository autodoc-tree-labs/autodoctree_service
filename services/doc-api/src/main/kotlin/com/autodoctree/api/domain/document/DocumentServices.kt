...
@Service
class AuditService(
    private val auditLogRepository: com.autodoctree.api.db.admin.AuditLogRepository,
...
@Service
class OutboxService(
    private val outboxRepository: com.autodoctree.api.db.pipeline.OutboxRepository,
    private val objectMapper: ObjectMapper
) {
